...
const Admin = () => {
    ...
    let [productDetails, setProductDetails] = useState({ title: "", description: "", image: "", author: "", price: "", producerEmail: ""  });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            productDetails = { ...productDetails, producerEmail: user.attributes.email }
            setProductDetails(productDetails);
            await API.graphql(graphqlOperation(createProduct, { input: productDetails }))
            setProductDetails({ title: "", description: "", image: "", author: "", price: "", producerEmail: "" })
        } catch (err) {
